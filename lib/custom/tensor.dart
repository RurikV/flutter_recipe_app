...
export 'package:tflite_flutter/src/bindings/tensorflow_lite_bindings_generated.dart' show TfLiteType;
...
class Tensor {
  ...
  Uint8List get data {
    ...
    // Create a copy to ensure it's unmodifiable
    return Uint8List.fromList(data.asTypedList(tfliteBinding.TfLiteTensorByteSize(_tensor)));
  }
  ...
  Uint8List _convertObjectToBytes(Object o) {
    return CustomByteConversionUtils.convertObjectToBytes(o, type);
  }

  Object _convertBytesToObject(Uint8List bytes) {
    return CustomByteConversionUtils.convertBytesToObject(bytes, type, shape);
  }
